...
import { Filter, Header, SearchBar } from "./index";
...
const Home = () => {
  ...
  return (
    <div className="w-full h-auto flex items-center flex-col justify-center bg-primary">
      <Header />
      <SearchBar />
      ...
      {/* {allSongs &&
        allSongs.map((song, index) => (
          <MusicCard key={song._id} index={index} data={song} />
        ))} */}
    </div>
  );
};
